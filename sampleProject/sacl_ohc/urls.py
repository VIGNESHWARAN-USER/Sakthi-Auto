...
urlpatterns = [
    ...
    path("get_first_aid_consumable/", views.get_first_aid_consumables, name="get_first_aid_consumable"),
    path("add_first_aid_consumable/", views.add_first_aid_consumable, name="add_first_aid_consumable"),
    path("get_glucose_consumable/", views.get_glucose_consumables, name="get_glucose_consumable"),
    path("add_glucose_consumable/", views.add_glucose_consumable, name="add_glucose_consumable"),
